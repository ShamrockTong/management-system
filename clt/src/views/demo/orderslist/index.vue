  ...
  <d2-container>
    ...
    <!-- 详情 -->
      <el-dialog
          ...
          >
            <div>
              <el-form ref="detailsform" :rules="rules" :model="detailsform" label-width="100px">
...
export default {
  ...
  methods:{
    ...
    async getAllList(){
      ...
      await Axios.post('http://localhost:3000/api/getAllorders',postData).then(res=>{
    ...
    async doDel (row) {
      ...
      this.$refs.detailsform.validate(async (res, wtf) => {
        if (res) {
          ...
          // const res = await this.$api.post('/build/update', postData)
           ...
           await Axios.post(`http://localhost:3000/api/updateOrder`,postData).then(res=>{
            console.log(res);
     ...
     async searchRes(searchInfo){
      //  console.log(searchInfo);
        ...
        await Axios.post(`http://localhost:3000/api/searchOrders`,postData).then(res=>{
