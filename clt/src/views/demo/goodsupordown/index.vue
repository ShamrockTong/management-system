<template>
  <d2-container>
    <template slot="header">
      ...
      <el-button type="danger" @click="downAll" class="headerbutton">下架所有商品</el-button>
      <el-button type="primary" @click="upAll" class="headerbutton">上架所有商品</el-button>
    </template>
  ...
  methods:{
    ...
    async getAllList(){
      ...
      await Axios.post('http://localhost:3000/api/getAllgoods',postData).then(res=>{
        ...
        async upAll () {
          console.log('upAll');
           await Axios.post(`http://localhost:3000/api/upAllGoods`).then(res=>{
             if(res.data.success){
        ...
        async downAll () {
          console.log('downAll');
           await Axios.post(`http://localhost:3000/api/downAllGoods`).then(res=>{
             if(res.data.success){
     ...
     async searchRes(searchInfo){
      ...
      async changeupordown(val){
        ...
        await Axios.post(`http://localhost:3000/api/upordown`,postData).then(res=>{
          if(val){
